...
/// <summary>
/// Lifecycle state of a WebRTC <see cref="IPeerConnection"/>, modelled on the W3C
/// <c>RTCPeerConnectionState</c> (RFC 8829): a signalling-neutral view of where the peer is between
/// creation and teardown. ICE consent and the DTLS handshake drive the transitions.
/// </summary>
